                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="{{url('wx')}}" method="get" class="registration-form">
			                        ...
			                        <div class="form-group">
			                        	...
			                        	<input type="text" name="form-last-name" placeholder="输入您的密码" class="form-last-name form-control" id="form-last-name">
                                    </div>
